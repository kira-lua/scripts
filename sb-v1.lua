...
--     return targetGlobal ~= nil and targetGlobal ~= ""
-- end
...
openBtn.Size = UDim2.fromOffset(30, 30) -- carré
openBtn.Position = UDim2.fromScale(0.85, -0.14)
openBtn.Text = "K"
openBtn.Font = Enum.Font.GothamBold
openBtn.TextSize = 22
openBtn.BackgroundColor3 = Color3.fromRGB(0,0,0)
openBtn.TextColor3 = Color3.fromRGB(255,255,255)
openBtn.Rotation = -90 -- K couché
openBtn.ZIndex = 99999999
openBtn.Parent = gui

-- coins arrondis
local corner = Instance.new("UICorner")
corner.CornerRadius = UDim.new(0, 4) -- radius 4px
...
-- remettre le gui devant si respawn
player.CharacterAdded:Connect(function()
    gui.Parent = player:WaitForChild("PlayerGui")
end)
local frame = Instance.new("Frame")
frame.Size = UDim2.fromScale(0.6, 0.8)
frame.Position = UDim2.new(0.5,0,0.5 - (30 / workspace.CurrentCamera.ViewportSize.Y),0)
...
Players.PlayerRemoving:Connect(function(plr)
    if targetGlobal == plr.Name then
        ...
        notif.Position = UDim2.new(1, 10, 1, -60) -- départ juste en dehors de l'écran à droite
        ...
        -- après 3 secondes, repart vers la droite et détruit
        task.spawn(function()
            task.wait(3)
