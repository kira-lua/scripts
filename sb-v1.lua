...
openBtn.Position = UDim2.fromScale(0.02, 0.51)
openBtn.Text = "K"
openBtn.Font = Enum.Font.GothamMedium
openBtn.TextSize = 22
openBtn.BackgroundColor3 = Color3.fromRGB(0,0,0)
openBtn.TextColor3 = Color3.fromRGB(170,170,170)
openBtn.Rotation = -90
...
username.Position = UDim2.new(0, avatar.Size.X.Offset + 15, 0, 33)
...
display.Position = UDim2.new(0, avatar.Size.X.Offset + 15, 0, 53)
...
Players.LocalPlayer.CharacterAdded:Connect(function(char)
    ...
    if standActive and targetGlobal then
        task.wait(0.2) -- laisser Roblox finir le spawn
        Stand(targetGlobal)
    end
end)